...
/** Shared by /admin/[projectId]/status and /project/[accessToken]/status - see project-page-content.tsx for why. */
export default async function StatusPageContent({
  projectId,
  accessToken,
}: {
  projectId: string;
  ...
  return (
    <div className="space-y-4">
      <Link href={basePath} className="im-link text-sm">
      ...
      {project.access_mode === "open" ? (
        ...
        <div className="space-y-2">
          ...
          <StartTimerButton projectId={project.id} accessToken={accessToken} />
        </div>
      )}
