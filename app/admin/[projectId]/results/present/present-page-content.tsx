...
/** Shared by /admin/[projectId]/results/present and /project/[accessToken]/results/present - see project-page-content.tsx for why. */
export default async function PresentPageContent({
  projectId,
  accessToken,
}: {
  projectId: string;
